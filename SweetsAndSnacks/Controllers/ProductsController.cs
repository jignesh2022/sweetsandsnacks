...
namespace SweetsAndSnacks.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,Description,Category,Pricing," +
            "PricingQuantity,QuantityUnit,Stock,Photo")] Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (product.Photo != null)
                    {
                        ...
                        uniqueFileName = String.Concat($"{product.ProductName.Replace(" ", "-")}", Path.GetExtension(product.Photo.FileName));
                    ...
                    {
                        product.ImageName = "no-image.jpg";
                    }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,Description,Category,Pricing," +
            "PricingQuantity,QuantityUnit,Stock,ImageName,Photo,LastUpdatedBy,LastUpdatedAt")] Product product)
        {
